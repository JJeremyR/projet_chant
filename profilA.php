        ...
        <body>
            ...
            <section>
                ...
                <article class="content">
                    ...
                    <?php //include ('components/admin/notifs.php'); ?>
                        ...
                        <table align="center" border="3">
                            <tbody>
                                ...
                                <tr align="center" border="3">
                                    ...
                                    <td><?=$m['nom']?></td>
                                    <td><?=$m['mail']?></td>
                                    <td><?php if($m['conf'] == 0){ ?><button><a href="profilA.php?type=user&conf=<?= $m['id'] ?>">Valider la candidature</a></button></td>
                                    <td><?php } ?><button><a href="profilA.php?type=user&sup=<?= $m['id'] ?>">Rejeter la Canditature</a></button></td>
                                </tr>
                                <?php } ?>      
                            </tbody>
                        </table>
                        ...
                        <table align="center" border="3">
                            <tbody>
                                ...
                                <tr align="center" border="3">
                                    ...
                                    <td><?=$s['titre']?></td>
                                    <td><?=$s['fichier']?></td>
                                    <td><?php if($s['conf'] == 0){?><button><a href="profilA.php?type=song&conf=<?=$s['id']?>">Valider la chanson</a></button><?php "  "?></td>
                                    <td><?php }?><button><a href="profilA.php?type=song&sup=<?=$s['id']?>">Rejeter la chanson</a></button></td>
                                </tr>
                                <?php }?>
                            </tbody>
                        </table>
            ...
            <section>
                <article class="content">
                    ...
                    <h2>Recapitulatif Candidatures Finalisées!</h2>

                    <?php //include ('components/admin/recap.php'); ?>
